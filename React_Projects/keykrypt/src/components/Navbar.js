            ...
            <header className="text-gray-600 border-b-2 border-gray-900 bg-teal-50 body-font font-[poppins]">
                ...
                <div className="container mx-auto flex flex-wrap p-2 px-7 flex-col md:flex-row items-center">
                    ...
                    <div className="lg:w-2/5 inline-flex lg:justify-end ml-5 lg:ml-0">
                        {!localStorage.getItem('keykrypt') ? <Link to={"/login"}><button className="inline-flex items-center bg-gray-100 border-0 py-1 px-3 focus:outline-none hover:bg-gray-200 rounded text-base mt-4 md:mt-0">Login
                            <svg fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" className="w-4 h-4 ml-1" viewBox="0 0 24 24">
                                <path d="M5 12h14M12 5l7 7-7 7"></path>
                            </svg>
                        </button></Link> : <button onClick={() => handleLogout} className="inline-flex items-center bg-gray-100 border-0 py-1 px-3 focus:outline-none hover:bg-gray-200 rounded text-base mt-4 md:mt-0">Logout
                            <svg fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" className="w-4 h-4 ml-1" viewBox="0 0 24 24">
                                <path d="M5 12h14M12 5l7 7-7 7"></path>
                            </svg>
                        </button>}
