    ...
    <>
      <div className={`${darkMode ? "dark:text-white dark:bg-gray-800" : ""}`}>
        <div className="container mx-auto py-8 px-2 md:px-0">
          ...
          <p className="mb-4">
            At Techbloom.com, our primary focus is customer satisfaction, which is why we strive to provide the best products and services. Please note that product images on our website are for representational purposes only and may vary slightly due to lighting conditions or other factors.
          </p>
          <p className="mb-4">
          ...
          <ul className="list-disc ml-8 mb-4">
            ...
            <li>To initiate a return request, customers can visit <a href="https://Techbloom.com/return" className="text-blue-500">Techbloom.com/return</a>.</li>
            <li>A valid reason is requipurple for returning an item.</li>
