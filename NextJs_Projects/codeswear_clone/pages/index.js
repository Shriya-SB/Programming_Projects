...
export default function Home({ darkMode }) {
  ...
  const slides = [
    ...
    {
      image: '/_85eb9472-c934-436b-8b0c-f63b9c46f311.jpeg'
    },
    {
      image: '/_fdb19d8c-6da3-4382-8116-f98dbeadaf1c.jpeg'
    },
    {
      image: '/_8019f98b-3d61-44a3-9a5d-1e32d7d1a1d3.jpeg'
    },
  ];
      ...
      <main>
        ...
        <div className={`relative h-[90vh] ${darkMode ? 'dark:bg-gray-700 dark:text-white' : 'bg-gray-100'}`}>
          ...
          >
            ...
            <span className="visually-hidden">
              <IoIosArrowDroprightCircle className="text-4xl font-bold" />
            </span>
          </button>
        </div>
