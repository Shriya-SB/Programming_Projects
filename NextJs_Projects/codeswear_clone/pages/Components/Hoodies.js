...
const Hoodies = ({ darkMode, products }) => {
  ...
  return (
    <>
      <section className={`body-font min-h-screen ${darkMode ? "dark:bg-gray-700 dark:text-white" : ""}`}>
        <h1 className='text-4xl text-center py-5 font-bold'>Hoodies for sale.</h1>
        <div className="container px-5 py-24 mx-auto">
          <div className="flex flex-wrap -m-4">
          {Object.keys(products).length === 0 && <h4 className='text-center justify-center items-center mx-auto text-3xl font-bold'>Sorry! Hoodies are out of stock. New stock coming soon..</h4>}
